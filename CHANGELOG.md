...
* **http**: Guard against response-splitting of HTTP headers by removing new-line (`[\r\n]`) characters from header names. Where user-supplied data is involved in the generation of header names, a malicious user may be able to craft responses that inject arbitrary data at the top of the body. Note that header values are already stripped of new-line characters. (Ben Noordhuis) [#2945](https://github.com/nodejs/node/pull/2945).
...
* **v8**: Update post-mortem metadata to allow post-mortem debugging tools to find and inspect JavaScript objects that use dictionary properties (Julien Gilli) [#2959](https://github.com/nodejs/node/pull/2959) & [#2974](https://github.com/nodejs/node/pull/2974).
